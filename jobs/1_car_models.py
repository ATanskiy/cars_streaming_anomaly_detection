...
from configs.spark.jobs.constants import schema_name, table_car_models as table_name
from configs.spark.jobs.create_tables import create_car_models_table
from configs.spark.jobs.generate_data import generate_car_models_data
...
#2 Create the table
create_car_models_table(spark, schema_name, table_name)

#3 Populate the table
df = generate_car_models_data(spark)
